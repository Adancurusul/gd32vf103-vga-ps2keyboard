...
#define PS2_DATA_WIDTH 11

u32 ps2_bit_count = PS2_DATA_WIDTH;
u32 into_count = 0;
u32 ps2_check = 0;
u32 ps2_data_now = 0;
u8 ps2_buffer[10];
...
static u8 shifted[][2] = {//when shift is hold
{0x1c,'A'},{0x5a,enter},{0x32,'B'},{0x21,'C'},{0x23,'D'},{0x24,'E'},{0x2b,'F'},{0x34,'G'},{0x33,'H'},
{0x43,'I'},{0x3b,'J'},{0x42,'K'},{0x4b,'L'},{0x3a,'M'},{0x31,'N'},{0X44,'O'},{0X4D,'P'},{0X15,'Q'},
{0X2D,'R'},{0X1B,'S'},{0X2C,'T'},{0X3C,'U'},{0X2A,'V'},{0X1D,'W'},{0X22,'X'},{0X35,'Y'},{0X1A,'Z'},
{0X45,')'},{0x16,'!'},{ 0x1e, '@' }, { 0x26, '#' }, { 0x25, '$' }, { 0x2e, '%' },{ 0x36, '^' },
{ 0x3d, '&' }, { 0x3e, '*' }, { 0x46, '(' },{ 0x0e, '~' }, { 0x4e, '_' }, { 0x55, '+' }, { 0x5d, '|' }, 
{ 0x54, '{' }, { 0x58, '}' }, {0x4c, ':' }, { 0x52, '\"' }, { 0x41, '<' }, { 0x49, '>' }, {0x4a, '?' },
};
static u8 unshifted[][2] = { { 0x1c, 'a' }, { 0x5a, enter },{ 0x32, 'b' }, { 0x21, 'c' }, {//when it is unshifted
